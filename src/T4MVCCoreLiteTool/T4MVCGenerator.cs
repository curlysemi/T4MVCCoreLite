...
using T4MVCCoreLiteTool.Services;

namespace T4MVCCoreLiteTool
{
    public class T4MVCGenerator
    {
        ...
        public const string GeneratedExtension = ".generated.cs";
        public const string R4MvcFileName = "T4MVCCore" + GeneratedExtension;
        public const string T4MvcFileName = "T4MVC.cs";
        ...
        public SyntaxNode Generate(CSharpCompilation compilation, ISettings settings)
        {
            ...
            var r4mvcNode =
                SyntaxFactory.CompilationUnit()
                    .WithUsings("System.CodeDom.Compiler", "System.Diagnostics", "System.Threading.Tasks", "System.Web", "System.Web.Mvc", settings.R4MvcNamespace)
                    .WithHeader(_headerText)
                    .WithPragmaCodes(false, pramaCodes);

            var controllers = _controllerRewriter.RewriteControllers(compilation, GeneratedExtension);
